...
namespace Handyman.Framework.Interfaces {
    public interface IMaster {
        ...
        /// <summary>
        /// Help url of the plugin, usally link to git README.MD file
        /// </summary>
        string HelpUrl { get; }
        ...
        /// <summary>
        /// Add all your commands as list of string, if you want to see them in suggestions when user starts typing.
        /// </summary>

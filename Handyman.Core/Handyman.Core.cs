...
namespace Handyman.Core
{
	...
	/// </summary>
	public class HandymansApplicationContext : ApplicationContext 
	{
		...
		/// </summary>
		public HandymansApplicationContext() 
		{
		...
		private void OnAddWordSystemHotkeyPressed(object sender, EventArgs e)
		{
			...
			Context.Current.AddActiveApplicationHandyman(appExeName, appExePath);
		}

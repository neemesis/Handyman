using Handyman.EmailPlugin.Properties;
...
namespace Handyman.EmailPlugin {
    public class EmailPlugin : IMaster {
        ...
        private void DisplayHelp() {
            ...
            var tl = new Label {
                ...
                + "example: " + _alias + " s:Hello from Handymans b:This is body t:email1@am.amam t:email2@am.amam\r\n"
            };
